...
public class EmailBuilder {
	...
	public static String getJobApplicationAcceptMsg(String userName) {
		StringBuilder msg = new StringBuilder();

		msg.append("<HTML><BODY>");
		msg.append("<H3>Hi, "+userName+"</H3>");
		msg.append("<P><B> Your Job Application is accepted by the recruiter.</B></p>");
		msg.append("</BODY></HTML>");
