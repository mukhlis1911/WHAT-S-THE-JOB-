...
import in.co.job.portal.controller.BaseCtl;
import in.co.job.portal.controller.JPView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(JPView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
	...
	public static String subFile(HttpServletRequest request, HttpServletResponse response,String name)
		...
		//String savePath = DataUtility.getString(PropertyReader.getValue("filePath"));
		 System.out.println("rizi path:"+ System.getProperty("user.dir"));

		File fileSaveDir = new File(System.getProperty("user.dir")+"/filesJobPortal");
		if (!fileSaveDir.exists()) {
			fileSaveDir.mkdir();
		}
		Part part = request.getPart("file");
		String fileName = extractFileName(part);
		part.write(System.getProperty("user.dir")+"/filesJobPortal" + File.separator + name+fileName);
