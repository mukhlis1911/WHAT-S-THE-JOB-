...
public class JobBean extends BaseBean {
	...
	public String toString() {
		return "JobBean [companyName=" + companyName + ", language=" + language + ", Description=" + Description
				+ ", postDate=" + postDate + ", postByRecId=" + postByRecId + ", address=" + address + ", recruiterId="
				+ recruiterId + ", jobId=" + jobId + ", userId=" + userId + ", applayDate=" + applayDate + ", userName="
				+ userName + ", resumeFile=" + resumeFile + "]";
	}
