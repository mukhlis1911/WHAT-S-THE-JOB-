				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="<%=JPView.USER_REGISTRATION_CTL%>" method="post">
							...
							<div class="form-group row">
								<label for="email_address"
									class="col-md-4 col-form-label text-md-right">Gender<font
									color="red">*</font></label>
								<div class="col-md-6">
									<input type="text" id="email_address" class="form-control"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="radio" class="col-md-1" name="userType"
										value="Candidate"> <label for="userType"
										class="text-md-left">Candidate</label> <input type="radio"
										class="col-md-1" name="userType" value="Recruiter"> <label
										for="userType">Recruiter</label> <br> <font color="red"><%=ServletUtility.getErrorMessage("userType", request)%></font>
